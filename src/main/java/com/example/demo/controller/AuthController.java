...
public class AuthController {
    ...
    public AuthResponse refresh(AuthUser authUser) {
        return getAuthResponse(authUser);
    }
    ...
    public AuthUserResponse authUser(@RequestBody @Valid AuthUserResponse authUser, @PathVariable String service) {
    ...
    private AuthResponse getAuthResponse(AuthUser loginUser) {
