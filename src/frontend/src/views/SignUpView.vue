        ...
        <div class="container">
            <el-form :model="form" :rules="rules" ref="loginFormRef" label-width="120px" class="custom-form">
                <el-form-item label="이메일" prop="email" required>
                    <el-input type="text" v-model="form.email" placeholder="이메일 입력"/>
                </el-form-item>
                <el-button class="m-lg-1" @click="checkEmailAvailability" type="primary">중복 검증</el-button>
...
const submitForm = () => {
    loginFormRef.value.validate((valid) => {
        if (valid) {
            // form.value.add1 = document.getElementById("sample6_postcode").value;
            // form.value.add2 = document.getElementById("sample6_address").value;
